...
public class CNRoundedButton extends Button {
    public float cornerRadius;
    private Path clipPath;
    private RectF rect;

    public CNRoundedButton(Context context) {
        super(context);
    }

    public CNRoundedButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CNRoundedButton(Context context, AttributeSet attrs, int defStyleAttr) {
