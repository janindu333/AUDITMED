...
import com.iot.panel.common.Constants;
...
public class Alert {
    ...
    public static void show(Activity activity, String title, String message, String positiveBtnTxt,
        ...
        if (activity != null && !activity.isFinishing()) {
            ...
            alertDialogBuilder.setTitle(titleTxt);
            alertDialogBuilder.setMessage(messageTxt);
            alertDialogBuilder.setPositiveButton(positiveBtnTxt, positiveListener);
            AlertDialog alertDialog = alertDialogBuilder.create();
            alertDialog.setCancelable(false);
            alertDialog.setCanceledOnTouchOutside(false);
            alertDialog.show();
    ...
    public static void showUpdate(Activity activity, String title, String message,
        ...
        if (activity != null && !activity.isFinishing()) {
            ...
            final CardView dialogView =
                    (CardView) inflater.inflate(R.layout.layout_update, null);
    ...
    public static void tryAgainDialog(Activity activity, String title, String message, String positiveBtnTxt,
                                      String negativeBtnTxt, final DialogInterface.OnClickListener positiveListener,
